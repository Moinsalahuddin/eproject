...
<section class="w3l-inner-banner-main">
    <div class="about-inner contact ">
        <div class="container">   
            ...
            <h3 class="header-name animated-text">Change Password</h3>
        </div>
</div>
</div>
...
?>
                    ...
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                            <span class="fa fa-envelope-o text-"></span>
                        </div>
                        <div class="cont-right">
                    ...
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                            <span class="fa fa-map-marker text-"></span>
                        </div>
                        <div class="cont-right">
               ...
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <h3 style="color:#d19f68;font-weight:bold"class="animated-text">Password change!!</h3>
