...
?>
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            ...
                            <p class="para text-dark"> <?php  echo $row['PageDescription'];?></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            ...
                            <p class="para text-dark"> <?php  echo $row['Timing'];?></p>
                        </div>
                    </div>
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-contact" name="submit"STYLW>Send Message</button>
                    </form>
                </div>
    </div>
