...
/* Reset hover styles */
.btn-primary:hover {
    background-color: #ffffff; /* Same as default background */
    color: #000; /* Same as default text color */
}

.btn-danger:hover {
    background-color: #ff0000; /* Same as default background */
    border-color: #f1f1f1; /* Same as default border color */
}
