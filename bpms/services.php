...
<html lang="en">
  <head>
    ...
    <title>Elegance Salon| service Page </title>
...
?>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 ...
                 ['Image']?>" alt="product" height="300" width="400" class="img-responsive about-me" id="services1"
                 style="border-radius:50px">
                    <div class="about-grids ">
                        <hr>
                        <h5 class="para mt-5 animated-text" style="font-weight:bold;color:#d19f68"><?php echo  $row['ServiceName'];?></h5>
                        <p class="para mt-5 "><?php echo $row['ServiceDescription'];?> </p>
                        <p class="para mt-5 mb-5" style="color: #d19f68;"> Cost of Service: $<?php  echo $row['Cost'];?> </p>
