...
.w3l-contact-info-main button.btn-contact {
    ...
    <title>Elegance Salon | Booking History</title>
            ...
            <div>
                <div class="cont-details">
                   <div class="table-content table-responsive cart-table-content m-t-30">
                    <h4 style="padding-bottom: 20px;text-align: center;color: #d19f68;font-weight:bold;font-family:arial">Appointment History</h4>
                        <table border="2" class="table">
                            <thead class="gray-bg" >
                                <tr>
                                <th style="background-color:black;color:#d19f68">#</th>
                                <th style="background-color:black;color:#d19f68">Appointment Number</th>
                                <th style="background-color:black;color:#d19f68">Appointment Date</th>
                                <th style="background-color:black;color:#d19f68">Appointment Time</th>
                                <th style="background-color:black;color:#d19f68">Appointment Status</th>
                                <th style="background-color:black;color:#d19f68">Action</th>
                                </tr>
                            </thead>
                            <tbody>
...
$cnt=1;
              ...
              { ?>
               <tr>
<td style="background-color:#d19f68;color:black"><?php echo $cnt;?></td>
<td style="background-color:#d19f68;color:black"><?php echo $row['AptNumber'];?></td>
<td style="background-color:#d19f68;color:black"><p> <?php echo $row['AptDate']?> </p></td> 
<td style="background-color:#d19f68;color:black"><?php echo $row['AptTime']?></td> 
<td style="background-color:#d19f68;color:black"><?php $status=$row['Status'];
if($status==''){
...
<td style="background-color:#d19f68;"><a href="appointment-detail.php?aptnumber=<?php echo $row['AptNumber'];?>" class="btn btn-dark">View</a></td>       
</tr><?php $cnt=$cnt+1; } ?>
